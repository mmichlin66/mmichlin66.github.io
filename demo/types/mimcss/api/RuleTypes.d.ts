import { ICustomVar, OneOrMany, PseudoEntity, CssSelector, PagePseudoClass, IParameterizedPseudoEntity, IRuleWithSelector } from "../api/BasicTypes";
...
export interface IStyleRule extends IRule, IRuleWithSelector {
     ...
     */
    setProp<K extends keyof ExtendedStyleset>(name: K, value: ExtendedStyleset[K], important?: boolean, schedulerType?: number): void;
    /**
     ...
     * value to the DOM. If undefined, the current default scheduler will be used.
     */
    setCustomProp<K extends VarTemplateName>(customVar: IVarRule<K>, value: VarValueType<K>, important?: boolean, schedulerType?: number): void;
}
/**

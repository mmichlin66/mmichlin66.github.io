 ...
 */
export declare function rgb(r: number, g: number, b: number, a?: number): ColorTypes.IColorProxy;
/**
 ...
 * @param a Optional alpha mask as a percentage value.
 */
export declare function hsl(h: number | string, s: number, l: number, a?: number): ColorTypes.IColorProxy;
/**
 ...
 */
export declare function alpha(c: number | keyof ColorTypes.INamedColors, a: number): ColorTypes.IColorProxy;

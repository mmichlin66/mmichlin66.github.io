...
### Features
The goal of the Mimcss library is to support all CSS features in a type-safe and easy to use manner.
...
- Type safety and autocomplete (Intellisense) support for CSS properties. This eliminates misspelling errors.

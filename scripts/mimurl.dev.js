...
/*!********************!*\
  !*** ./lib/api.js ***!
  \********************/
/*! exports provided: EUrlPart, FieldFormat, parseURL, parseUrlPattern, match */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EUrlPart", function() { return EUrlPart; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FieldFormat", function() { return FieldFormat; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "parseURL", function() { return parseURL; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "parseUrlPattern", function() { return parseUrlPattern; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "match", function() { return match; });
/* harmony import */ var _actual__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./actual */ "./lib/actual.js");
/* harmony import */ var _parser__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./parser */ "./lib/parser.js");
/* harmony import */ var _matcher__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./matcher */ "./lib/matcher.js");
/**
 ...
 */
function parseURL(s) {
    return _actual__WEBPACK_IMPORTED_MODULE_0__["parseURL"](s);
}
/**
...
function parseUrlPattern(s) {
    return _parser__WEBPACK_IMPORTED_MODULE_1__["parsePattern"](s);
}
/**
...
function match(url, pattern) {
    return _matcher__WEBPACK_IMPORTED_MODULE_2__["match"](url, pattern);
}
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "EUrlPart", function() { return _api__WEBPACK_IMPORTED_MODULE_0__["EUrlPart"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "FieldFormat", function() { return _api__WEBPACK_IMPORTED_MODULE_0__["FieldFormat"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "parseURL", function() { return _api__WEBPACK_IMPORTED_MODULE_0__["parseURL"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "parseUrlPattern", function() { return _api__WEBPACK_IMPORTED_MODULE_0__["parseUrlPattern"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "match", function() { return _api__WEBPACK_IMPORTED_MODULE_0__["match"]; });
...
/*!************************!*\
  !*** ./lib/matcher.js ***!
  \************************/
/*! exports provided: match, matchParsed */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "match", function() { return match; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "matchParsed", function() { return matchParsed; });
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api */ "./lib/api.js");
...
function match(url, pattern) {
    ...
    if (typeof url === "string") {
        if (typeof pattern === "string")
            return matchParsed(_api__WEBPACK_IMPORTED_MODULE_0__["parseURL"](url), _api__WEBPACK_IMPORTED_MODULE_0__["parseUrlPattern"](pattern));
        else
            return matchParsed(_api__WEBPACK_IMPORTED_MODULE_0__["parseURL"](url), pattern);
    }
    else {
        if (typeof pattern === "string")
            return matchParsed(url, _api__WEBPACK_IMPORTED_MODULE_0__["parseUrlPattern"](pattern));
        else
...
function matchParsed(parsedURL, parsedPattern) {
    ...
    try {
        ...
        let error = matchSingleSegment(_api__WEBPACK_IMPORTED_MODULE_0__["EUrlPart"].Protocol, parsedURL.protocol, parsedPattern.protocol ? parsedPattern.protocol.segment : null, matchResult.fields);
        if (error)
            errors.push(error);
        error = matchMultipleSegments(_api__WEBPACK_IMPORTED_MODULE_0__["EUrlPart"].Hostname, parsedURL.hostname, parsedPattern.hostname ? parsedPattern.hostname.segments : null, matchResult.fields);
        if (error)
            errors.push(error);
        error = matchSingleSegment(_api__WEBPACK_IMPORTED_MODULE_0__["EUrlPart"].Port, parsedURL.port, parsedPattern.port ? parsedPattern.port.segment : null, matchResult.fields);
        if (error)
            errors.push(error);
        error = matchMultipleSegments(_api__WEBPACK_IMPORTED_MODULE_0__["EUrlPart"].Path, parsedURL.path, parsedPattern.path ? parsedPattern.path.segments : null, matchResult.fields);
        if (error)
            errors.push(error);
        error = matchQueryString(parsedURL.query, parsedPattern.query, matchResult.fields);
        if (error)
            errors.push(error);
        error = matchSingleSegment(_api__WEBPACK_IMPORTED_MODULE_0__["EUrlPart"].Hash, parsedURL.hash, parsedPattern.hash ? parsedPattern.hash.segment : null, matchResult.fields);
        if (error)
            errors.push(error);
    }
    catch (err) {
...
function matchSingleSegment(urlPart, actualSegment, parsedSegment, fields) {
    ...
    if (!parsedSegment) {
        if (actualSegment)
            return `URL part '${_api__WEBPACK_IMPORTED_MODULE_0__["EUrlPart"][urlPart]}' contains segment '${actualSegment}' that doesn't exist in the pattern`;
        else
            return null;
    }
    ...
    if (!actualSegment) {
        if (parsedSegment.isOptional)
            ...
            return `URL part '${_api__WEBPACK_IMPORTED_MODULE_0__["EUrlPart"][urlPart]}' doesn't have a segment corresponding ` +
                `to a mandatory pattern segment '${parsedSegment.tokenSting}'`;
    }
    return tryMatchSingleSegment(actualSegment, parsedSegment, fields)
        ? null
        : `URL segment '${actualSegment}' in part '${_api__WEBPACK_IMPORTED_MODULE_0__["EUrlPart"][urlPart]}' doesn't match ` +
...
function matchMultipleSegments(urlPart, actualSegments, parsedSegments, fields) {
    if (!actualSegments && !parsedSegments)
        ...
        return `URL doesn't have part '${_api__WEBPACK_IMPORTED_MODULE_0__["EUrlPart"][urlPart]}' that exists in the pattern`;
    else if (!parsedSegments)
        return `URL has part '${_api__WEBPACK_IMPORTED_MODULE_0__["EUrlPart"][urlPart]}' that doesn't exist in the pattern`;
    ...
    if (tryMatchMultipleSegments(actualSegments, 0, compiledSegments, 0, fields))
        ...
        return `URL part '${_api__WEBPACK_IMPORTED_MODULE_0__["EUrlPart"][urlPart]}' doesn't match the pattern`;
}
...
function convertFieldValue(parsedField, stringValue) {
    ...
    switch (parsedField.format) {
        case _api__WEBPACK_IMPORTED_MODULE_0__["FieldFormat"].Integer:
            {
                let v = Number(stringValue);
                return isNaN(v) || !Number.isInteger(v) ? parsedField.defaultValue : v;
            }
        case _api__WEBPACK_IMPORTED_MODULE_0__["FieldFormat"].Float:
            {
                let v = Number(stringValue);
                return isNaN(v) ? parsedField.defaultValue : v;
            }
        case _api__WEBPACK_IMPORTED_MODULE_0__["FieldFormat"].Boolean:
            {
...
class ParsedUrlPattern {
    ...
    // Protocol URL part.
    get protocol() { return this.parts[_api__WEBPACK_IMPORTED_MODULE_0__["EUrlPart"].Protocol]; }
    // Hostname URL part.
    get hostname() { return this.parts[_api__WEBPACK_IMPORTED_MODULE_0__["EUrlPart"].Hostname]; }
    // Port URL part.
    get port() { return this.parts[_api__WEBPACK_IMPORTED_MODULE_0__["EUrlPart"].Port]; }
    // Path URL part.
    get path() { return this.parts[_api__WEBPACK_IMPORTED_MODULE_0__["EUrlPart"].Path]; }
    // Query String URL part.
    get query() { return this.parts[_api__WEBPACK_IMPORTED_MODULE_0__["EUrlPart"].Query]; }
    // Hash URL part.
    get hash() { return this.parts[_api__WEBPACK_IMPORTED_MODULE_0__["EUrlPart"].Hash]; }
...
class ParsedProtocol extends ParsedSingleSegmentUrlPart {
    constructor() { super(_api__WEBPACK_IMPORTED_MODULE_0__["EUrlPart"].Protocol, false); }
...
class ParsedHostname extends ParsedMultiSegmentUrlPart {
    constructor() { super(_api__WEBPACK_IMPORTED_MODULE_0__["EUrlPart"].Hostname, false); }
    getSegmentEndCharacters() { return ".:/?#"; }
...
class ParsedPort extends ParsedSingleSegmentUrlPart {
    constructor() { super(_api__WEBPACK_IMPORTED_MODULE_0__["EUrlPart"].Port, false); }
    getSegmentEndCharacters() { return "/?#"; }
    getNextUrlPart() {
        if (g_currChar === '/') {
            g_move();
...
class ParsedPath extends ParsedMultiSegmentUrlPart {
    constructor() { super(_api__WEBPACK_IMPORTED_MODULE_0__["EUrlPart"].Path, true); }
    getSegmentEndCharacters() { return "/?#"; }
    getPartEndCharacters() { return "?#"; }
    getNextUrlPart() {
        if (g_currChar === '?') {
...
class ParsedQueryString extends ParsedUrlPart {
    constructor() {
        super(_api__WEBPACK_IMPORTED_MODULE_0__["EUrlPart"].Query, true);
        this.parsedQSPs = {};
...
class ParsedHash extends ParsedSingleSegmentUrlPart {
    constructor() { super(_api__WEBPACK_IMPORTED_MODULE_0__["EUrlPart"].Hash, true); }
    getSegmentEndCharacters() { return ""; }
    getNextUrlPart() {
        return null;
    }
...
class ParsedField extends ParsedToken {
    constructor() {
        ...
        this.isOptional = false;
        this.name = "";
        this.format = _api__WEBPACK_IMPORTED_MODULE_0__["FieldFormat"].String;
    ...
    parse(segmentEndChars) {
        ...
        if (g_currChar === '%') {
            ...
            if (formatChar === 'i') {
                this.format = _api__WEBPACK_IMPORTED_MODULE_0__["FieldFormat"].Integer;
                g_move();
            }
            else if (formatChar === 'f') {
                this.format = _api__WEBPACK_IMPORTED_MODULE_0__["FieldFormat"].Float;
                g_move();
            }
            else if (formatChar === 'b') {
                this.format = _api__WEBPACK_IMPORTED_MODULE_0__["FieldFormat"].Boolean;
                g_move();
            }
            else
    ...
    parseDefaultValue(segmentEndChars) {
        ...
        if (this.format === _api__WEBPACK_IMPORTED_MODULE_0__["FieldFormat"].Integer) {
        ...
        else if (this.format === _api__WEBPACK_IMPORTED_MODULE_0__["FieldFormat"].Float) {
            this.defaultValue = Number(s);
        ...
        else if (this.format === _api__WEBPACK_IMPORTED_MODULE_0__["FieldFormat"].Boolean) {
            let v = s.toLowerCase();
            if (v === "true" || v === "t" || v === "yes" || v === "y" || v === "1")
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,